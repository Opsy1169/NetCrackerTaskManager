...
//        Task task1 = new Task("Zadacha1", "CheckWork", new GregorianCalendar(2018, Calendar.DECEMBER, 10, 10, 30), new String[]{"9999999", "8888888"});
//        tasklist.add(task1);
//        Task task2 = new Task("Zadacha2", "CheckWork", new GregorianCalendar(2017, Calendar.DECEMBER, 10, 11, 30), new String[]{"9999999", "8888888"});
//        tasklist.add(task2);
...
//        UtilStuff.saveJournal(journal);
        ...
        System.out.println(journal);
        System.out.println(UtilStuff.deleteAllPassedDates(journal));
